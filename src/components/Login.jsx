                ...
                {mode === "signup" && (
                  ...
                  >
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 focus:border-cyan-500/60 rounded-xl py-3 px-4 text-white placeholder-slate-600 text-sm outline-none transition-all focus:bg-white/8 focus:shadow-[0_0_16px_rgba(34,211,238,0.15)]"
                    />
                  </motion.div>
                )}
              </AnimatePresence>
                ...
                <form onSubmit={handleForgotPassword} className="space-y-3">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 focus:border-cyan-500/60 rounded-xl py-3 pl-10 pr-4 text-white placeholder-slate-600 text-sm outline-none transition-all"
                    />
                  </div>
                  {error && (
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 rounded-2xl font-black text-slate-950 text-sm bg-gradient-to-r from-cyan-400 to-purple-500 hover:opacity-90 transition-opacity disabled:opacity-60"
                  >
