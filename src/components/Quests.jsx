...
export function Quests({ setActiveTab }) {
  return (
      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Choose your path and conquer the learning kingdoms.
          </p>
        </div>
      ...
      <section className="bg-slate-900/40 border border-white/5 rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-slate-400 mb-8">
            Join forces with your team and compete in the ultimate coding
            challenge. Top teams win exclusive legendary gear.
          </p>
          <div className="flex gap-4">
            <button
              onClick={() => setActiveTab?.("contests")}
              className="px-8 py-3 bg-indigo-600 text-white font-black rounded-xl hover:bg-indigo-500 transition-all shadow-[0_0_20px_rgba(79,70,229,0.4)]"
            >
              JOIN TOURNAMENT
            </button>
            <button
              onClick={() => setActiveTab?.("contests")}
              className="px-8 py-3 bg-white/5 text-white font-black rounded-xl hover:bg-white/10 transition-all"
            >
              VIEW RULES
            </button>
          </div>
